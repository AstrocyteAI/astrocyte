"""Tests for astrocytes.eval — MemoryEvaluator, suites, metrics, regressions."""
...
from astrocytes.eval.evaluator import MemoryEvaluator, detect_regressions, format_comparison
from astrocytes.eval.metrics import (
    ndcg_at_k,
    percentile,
    precision_at_k,
    recall_hit,
...
from astrocytes.eval.suite import EvalSuite, RecallCase, ReflectCase, RetainCase, load_suite
from astrocytes.testing.in_memory import InMemoryEngineProvider
from astrocytes.types import EvalMetrics
