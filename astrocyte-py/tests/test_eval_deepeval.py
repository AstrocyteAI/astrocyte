...
from astrocyte.eval.deepeval_judge import DeepEvalScores, _safe_mean
from astrocyte.eval.evaluator import MemoryEvaluator
from astrocyte.eval.suite import EvalSuite, RecallCase, RetainCase
...
class TestDeepEvalImportCheck:
    def test_deepeval_importable(self):
        ...
        pytest.importorskip(
            "deepeval", reason="install optional extra: pip install 'astrocyte[eval]' or pip install deepeval"
        )
...
class TestLongMemEvalDataLoading:
    def test_load_from_json(self, tmp_path: Path):
        ...
        from astrocyte.eval.benchmarks.longmemeval import load_longmemeval_dataset
