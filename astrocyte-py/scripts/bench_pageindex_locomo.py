...
async def _populate_section_index(
    *,
    ...
    # 70% (~12pp drag) for a LoCoMo lift that didn't replicate (80.5%→77.5%,
    # i.e. judge noise). The Hindsight comparison clarified that auto-
    # updating prose wikis is the wrong shape — fact-grain atomic
    # observations (Phase 4 of the M14 plan) are the right architectural
    # fix. The wiki_incremental module + SPI + tests remain in the codebase
    # as building blocks for the Phase 4 fact-grain observation layer; the
    # bench just doesn't wire them in anymore.
