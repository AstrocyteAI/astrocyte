...
| [`tier1-postgres/`](./tier1-postgres/) | [`astrocyte.yaml`](./tier1-postgres/astrocyte.yaml) | Tier 1 + **PostgreSQL + pgvector** — set `DATABASE_URL` / `ASTROCYTE_PG_DSN`, run migrations for production-shaped deploys. |
