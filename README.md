...
| [`astrocyte-services-py/`](astrocyte-services-py/README.md) | Optional reference **REST** server (**[`astrocyte-gateway-py/`](astrocyte-services-py/astrocyte-gateway-py/README.md)**). Compose for API + DB: [`astrocyte-services-py/docker-compose.yml`](astrocyte-services-py/docker-compose.yml). Docker image: [`astrocyte-gateway-py`](https://github.com/AstrocyteAI/astrocyte/pkgs/container/astrocyte%2Fastrocyte-gateway-py). |
| [`adapters-storage-py/`](adapters-storage-py/README.md) | Optional **Tier 1** **storage** adapters (`VectorStore` / `GraphStore` / `DocumentStore`): **PostgreSQL + pgvector + AGE** (**[`astrocyte-postgres/`](adapters-storage-py/astrocyte-postgres/README.md)**, [`astrocyte-age/`](adapters-storage-py/astrocyte-age/README.md)); combined Docker image: [`astrocyte-postgres`](https://github.com/AstrocyteAI/astrocyte/pkgs/container/astrocyte%2Fastrocyte-postgres). Qdrant, Neo4j, Elasticsearch. |
