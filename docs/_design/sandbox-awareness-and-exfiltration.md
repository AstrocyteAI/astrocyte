...
| **`astrocyte-services-py/astrocyte-gateway-py/`** (future) | Middleware: reject or map **sandbox** headers only when **signed** or **server-side** scoped; document **trusted** vs **untrusted** headers. |
