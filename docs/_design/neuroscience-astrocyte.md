...
Microglia survey the parenchyma and interact with synapses. With astrocyte they participate in **synaptic pruning** and inflammatory crosstalk. Activated microglia can secrete signals (e.g., IL-1α, TNF, C1q) that push astrocyte toward **A1-like** states, associated with loss of homeostatic functions and gain of damaging phenotypes in some models. Microglia–astrocyte pathways also affect **glutamate** and **connexin/hemichannel** behavior, linking immune activation to excitatory transmission and excitotoxic risk.
