...
The two shields.io endpoint badges at the top of the [main README](https://github.com/AstrocyteAI/astrocyte/blob/main/README.md) link to this page:

![LoCoMo](https://img.shields.io/endpoint?url=https://pub-fd2a5bf01e5b443085a14aedb49c4206.r2.dev/badges/locomo.json)
![LongMemEval](https://img.shields.io/endpoint?url=https://pub-fd2a5bf01e5b443085a14aedb49c4206.r2.dev/badges/longmemeval.json)
...
The full cycle-close + release ritual that drives badge changes lives in [`RELEASING.md`](https://github.com/AstrocyteAI/astrocyte/blob/main/RELEASING.md#cutting-a-release) at the repo root.
...
At release time, `release-mark-all` links the released package version(s) to the cycle in `BENCH_PARITY.yaml` and the README badges flip to display the released version's frozen scores. Full ritual in [`RELEASING.md`](https://github.com/AstrocyteAI/astrocyte/blob/main/RELEASING.md#cutting-a-release).
