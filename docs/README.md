...
| — | [Product roadmap v1 (M1–M6)](./_design/product-roadmap-v1.md) | Versioned milestones, gap-to-release mapping |
| — | [ADR-001 Deployment models](./_design/adr/adr-001-deployment-models.md) | Library vs standalone gateway vs gateway plugin |
| — | [ADR-002 Identity model](./_design/adr/adr-002-identity-model.md) | Structured `AstrocyteContext`, OBO, migration phases |
