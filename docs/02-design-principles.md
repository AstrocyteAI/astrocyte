...
This document translates recurring **organizing ideas** from astrocyte biology (see `01-neuroscience-astrocytes.md` and the review in `references/AstrocytesFromthePhysiologytotheDisease.pdf`) into **engineering metaphors** for AI systems. It is analogy, not a claim that software should mimic wetware literally.
