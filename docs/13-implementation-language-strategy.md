...
## 2. Hot paths in the Rust implementation (`astrocytes-rs`)

These components are strong candidates for native Rust in **`astrocytes-rs`** (CPU-bound, high frequency, or concurrency-sensitive):
